...
class ModelSellerOrder extends Model {
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *, (SELECT c.fullname FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer FROM `" . DB_PREFIX . "order` o WHERE o.store_id='". $this->config->get('config_store_id')."' AND o.order_id = '" . (int)$order_id . "'");
	...
	public function getOrders($data = array()) {
       ...
       $sql .= " AND customer_id ='".$this->customer->getId()."' AND o.store_id='".$this->config->get('config_store_id')."'";
	...
	public function getTotalOrders($data = array()) {
        ...
        $sql .= " AND customer_id = '".$this->customer->getId()."' AND store_id = '".$this->config->get('config_store_id')."'";
    ...
    public function getTotalOrdersTotal($data = array()) {
        $sql = "SELECT SUM(total) AS total, currency_code, currency_value FROM `" . DB_PREFIX . "order`";
        ...
        $sql .= " AND store_id = '".$this->config->get('config_store_id')."'";
	...
	public function getTotalOrdersByCompleteStatus($data = array()) {
		$implode = array();
		...
		if ($implode) {
            $sql = "SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "order` WHERE (" . implode(" OR ", $implode) . ")";
    ...
    public function getTotalOrdersTotalByCompleteStatus($data = array()) {
        $implode = array();
        ...
        if ($implode) {
            $sql = "SELECT SUM(total) AS total, currency_code, currency_value FROM `" . DB_PREFIX . "order` WHERE (" . implode(" OR ", $implode) . ")";
