                                    ...
                                    <div class="table-responsive">
                                        <table id="purchase-product" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr id="product-row<?php echo $product_row; ?>">
                                                ...
                                                <td class="text-left">
                                                    <?php foreach ($languages as $language) { ?>
                                                    <div class="input-group"><span class="input-group-addon"><img src="/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><input type="text" name="purchase_product[<?php echo $product_row; ?>][product_description][<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product['product_description'][$language['language_id']]) ? $product['product_description'][$language['language_id']]['name'] : ''; ?>" placeholder="产品名称" class="form-control" /></div>
                                                    <?php } ?>
                                                </td>
                                                <td class="text-left">
                                                    ...
                                                    <?php foreach ($languages as $language) { ?>
                                                    <div class="input-group"><span class="input-group-addon"><img src="/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><input type="text" name="purchase_product[<?php echo $product_row; ?>][product_description][<?php echo $language['language_id']; ?>][unit]" value="<?php echo isset($product['product_description'][$language['language_id']]) ? $product['product_description'][$language['language_id']]['unit'] : ''; ?>" placeholder="单位" class="form-control" /></div>
                                                    <?php } ?>
                                                </td>
                                                <td class="text-left">
                                                    <?php foreach ($languages as $language) { ?>
