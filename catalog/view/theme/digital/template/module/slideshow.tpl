...
<script  type="text/javascript">
    ...
    <div class="owl-ri right" style="width: 220px;background-color: white;border: 1px solid #e5e5e5;">
        ...
        <div style="width: 200px;margin:0 auto; text-align:center;border-bottom: 1px solid #f2f2f2;border-bottom-style: dashed">
            ...
            <?php }else{ ?>
            <li><a href="/index.php?route=account/register" style="margin: 10px auto;line-height: 30px;display: block;width: 166px; height: 30px;text-align: center;font-size: 14px; background-color: #3d4d99; border-radius: 5px; color: white;"><?php echo $text_free_registration; ?></a></li>
            <li><a href="/index.php?route=account/login" style="margin: 10px auto;line-height: 30px;display: block;width: 166px; height: 30px;text-align: center;font-size: 14px; background-color: #3d4d99; border-radius: 5px; color: white;"><?php echo $text_loginplease; ?></a></li>
            <?php } ?>
