  ...
  <div class="container">
    ...
    <div class="header clearfix">
      <div class="header_left">
        <div id="logo">
          <?php if ($logo) { ?>
          <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $shop_name; ?>" alt="<?php echo $shop_name; ?>"/></a>
          <?php } else { ?>
          <h1 style="float: left;"><a href="<?php echo $home; ?>"><?php echo $shop_name; ?></a></h1>
          <?php } ?>
        </div>
      </div>
