...
<link href=catalog/view/theme/<?php echo $config_template; ?>/stylesheet/ali-search.css type="text/css" rel="Stylesheet">
                          ...
                          <ul class="sw-ui-area-ab-prov">
                            ...
                            <li class="sw-ui-area-box-item sw-ui-area-abProv-im"><a class="sw-ui-area-box-link sw-ui-area-ab-prov-itemLink " href="#" p="湖北" c="" v="湖北">湖北</a>
                              <ul class="sw-ui-area-ab-prov-items">
                                ...
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="湖北" c="恩施土家族苗族自治州" title="恩施土家族苗族自治州"
                                                                   v="恩施土家族苗族自治州">恩施土家族</a></li>
                              </ul>
                            </li>
                            <li class="sw-ui-area-box-item sw-ui-area-abProv-im"><a class="sw-ui-area-box-link sw-ui-area-ab-prov-itemLink " href="#" p="湖南" c="" v="湖南">湖南</a>
                              <ul class="sw-ui-area-ab-prov-items">
                                ...
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="湖南" c="湘西土家族苗族自治州" title="湘西土家族苗族自治州"
                                                                   v="湘西土家族苗族自治州">湘西土家族</a></li>
                              </ul>
                            </li>
                            ...
                            <li class="sw-ui-area-box-item sw-ui-area-abProv-im"><a class="sw-ui-area-box-link sw-ui-area-ab-prov-itemLink " href="#" p="青海" c="" v="青海">青海</a>
                              <ul class="sw-ui-area-ab-prov-items">
                                ...
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="青海" c="海西蒙古族藏族自治州" title="海西蒙古族藏族自治州"
                                                                   v="海西蒙古族藏族自治州">海西蒙古族</a></li>
                              </ul>
                            </li>
                            ...
                            <li class="sw-ui-area-box-item sw-ui-area-abProv-im"><a class="sw-ui-area-box-link sw-ui-area-ab-prov-itemLink " href="#" p="云南" c="" v="云南">云南</a>
                              <ul class="sw-ui-area-ab-prov-items">
                                ...
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="云南" c="德宏傣族景颇族自治州" title="德宏傣族景颇族自治州"
                                                                   v="德宏傣族景颇族自治州">德宏傣族景</a></li>
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="云南" c="红河哈尼族彝族自治州" title="红河哈尼族彝族自治州"
                                                                   v="红河哈尼族彝族自治州">红河哈尼族</a></li>
                              </ul>
                            </li>
                            <li class="sw-ui-area-box-item sw-ui-area-abProv-im"><a class="sw-ui-area-box-link sw-ui-area-ab-prov-itemLink " href="#" p="贵州" c="" v="贵州">贵州</a>
                              <ul class="sw-ui-area-ab-prov-items">
                                ...
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="贵州" c="黔东南苗族侗族自治州" title="黔东南苗族侗族自治州"
                                                                   v="黔东南苗族侗族自治州">黔东南苗族</a></li>
                                <li class="sw-ui-area-box-item"><a class="sw-ui-area-box-link sw-ui-area-abProv-itemsubLink " href="#" p="贵州" c="黔南布依族苗族自治州" title="黔南布依族苗族自治州"
                                                                   v="黔南布依族苗族自治州">黔南布依族</a></li>
