                ...
                <div class="panel panel-default">
                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="input-sku"><span data-toggle="tooltip" title="产品统一编号，一种产品对应唯一编号"><?php echo $entry_sku; ?></span></label>
                                        <div class="col-sm-10">
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                ...
                                <div class="tab-pane" id="tab-links">
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="input-system-category"><?php echo $entry_system_category; ?></label>
                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left" style="width: 12%;"><?php echo $entry_subtract; ?></td>
                                    ...
                                    <div class="table-responsive">
                                        <table id="discount" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_quantity; ?></td>
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_priority; ?></td>
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_price; ?></td>
                                    ...
                                    <div class="table-responsive">
                                        <table id="auction" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_priority; ?></td>
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_price; ?></td>
                                                <td class="text-right" style="width: 10%;"><?php echo $entry_price_step; ?></td>
                                                <td class="text-left"><?php echo $entry_date_start; ?></td>
                                                <td class="text-left"><?php echo $entry_date_end; ?></td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr id="auction-row<?php echo $auction_row; ?>">
                                                <td class="text-left"><select name="product_auction[<?php echo $auction_row; ?>][customer_group_id]" class="form-control">
                                                        <?php foreach ($customer_groups as $customer_group) { ?>
                    ...
                    $('#input-description<?php echo $language['language_id']; ?>').summernote({
                        ...
                        /*onImageUpload: function(files, editor, $editable) {
                            ...
                            $.ajax({
                                ...
                                processData: false,
                                beforeSend: function() {
                                    $('#content').find('.text-danger').remove();
                                    $('#content .page-header').before('<div class="text-danger">Loading</div>');
                                },
                                complete: function() {
                                    $('#content').find('.text-danger').remove();
                                },
                                success: function(json) {
                                    ...
                                    if (json['error']) {
                                        $('#content').before('<div class="text-danger">' + json['error'] + '</div>');
                                    }

                                    if (json['success']) {
                                        //alert(json['success']);
                                        var reg=new RegExp("http[s]?://[^/]+(/.*)","gmi");
                                        var _src = json['src'].replace(reg, "$1");
                                        editor.insertImage($editable, _src);
                                    }
                                },
