<div id="content-<?php echo $dialog_id; ?>">
    <input type="hidden" name="offer_product[<?php echo $dialog_id; ?>][product_id]" value="<?php echo $offer_product_id; ?>" />
    <div class="page-header" style="margin-top: 0px;">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="button" onclick="saveOfferProduct(<?php echo $dialog_id; ?>)" form="form-product-<?php echo $dialog_id; ?>" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product-<?php echo $dialog_id; ?>" class="form-horizontal">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
            <li><a href="#tab-data-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_data; ?></a></li>
            <li><a href="#tab-links-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_links; ?></a></li>
            <li><a href="#tab-attribute-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            <li><a href="#tab-option-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <!--<li><a href="#tab-recurring-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>-->
            <li><a href="#tab-discount-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
            <li><a href="#tab-special-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_special; ?></a></li>
              <!--<li><a href="#tab-auction-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_auction; ?></a></li>-->
              <li><a href="#tab-image-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <!--<li><a href="#tab-reward-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_reward; ?></a></li>-->
            <!--<li><a href="#tab-design-<?php echo $dialog_id; ?>" data-toggle="tab"><?php echo $tab_design; ?></a></li>-->
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="dialog-language-<?php echo $dialog_id; ?>">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#language-<?php echo $dialog_id; ?>-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language-<?php echo $dialog_id; ?>-<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog<?php echo $dialog_id; ?>-input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="dialog<?php echo $dialog_id; ?>-input-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="product_quotation_note" rows="5" placeholder="<?php echo $entry_quotation_note; ?>" id="dialog-input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_quotation_note) ? $product_quotation_note : ''; ?></textarea>
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="tab-data-<?php echo $dialog_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-links-<?php echo $dialog_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-attribute-<?php echo $dialog_id; ?>">
                <div class="form-group">
            ...
            <div class="tab-pane" id="tab-option-<?php echo $dialog_id; ?>">
              <div class="row">
                <div class="col-sm-2">
            ...
            <div class="tab-pane" id="tab-recurring-<?php echo $dialog_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-discount-<?php echo $dialog_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-special-<?php echo $dialog_id; ?>">
              <div class="table-responsive">
              ...
              <div class="tab-pane" id="tab-auction-<?php echo $dialog_id; ?>">
                  <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-image-<?php echo $dialog_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-reward-<?php echo $dialog_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-design-<?php echo $dialog_id; ?>">
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
...
<?php foreach ($languages as $language) { ?>
$('#dialog<?php echo $dialog_id; ?>-input-description<?php echo $language['language_id']; ?>').summernote({height: 300});
<?php } ?>
//--></script> 
  <script type="text/javascript"><!--
...
function addRecurring() {
	...
	$('#tab-recurring-<?php echo $dialog_id; ?> table tbody').append(html);
}
//--></script> 
  <script type="text/javascript"><!--
$('.date').datetimepicker({
...
//--></script>
<script type="text/javascript"><!--
    $('#dialog-language-<?php echo $dialog_id; ?> a:first').tab('show');
