...
<link rel="stylesheet" href="catalog/view/theme/household/stylesheet/base.css">
<link href="catalog/view/theme/household/stylesheet/stylesheet.css" rel="stylesheet">

  <!-- load style start -->
  <!--my-main-page -->
  <script src="catalog/view/theme/household/js/index_my.js" type="text/javascript"></script>
  <!--<script src="js/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script>-->
  <link href="catalog/view/theme/household/stylesheet/normalize-3.0.3.css" type="text/css" rel="stylesheet">
  <link href="catalog/view/theme/household/stylesheet/my_main.css" type="text/css" rel="stylesheet">
  <!-- load style end -->

  <!--[if (lt IE 9)]><link href="catalog/view/theme/household/stylesheet/stylesheet-ltie9.css" rel="stylesheet"><![endif]-->
...
<script src="catalog/view/javascript/common.js" type="text/javascript"></script>
  <link href="catalog/view/theme/household/stylesheet/household.css" type="text/css" rel="stylesheet">
  ...
  <div class="container" style="padding: 0;">
    <div id="top-links" class="nav">
      ...
      <ul class="top-link-right-ul">
        ...
        <li style="margin-right: 8px"><a href=""><img src="catalog/view/theme/household/image/weibo.png" style="margin-top: -2px"></a></li>
        <li style="margin-right: 20px"><a href=""><img src="catalog/view/theme/household/image/weixin.png"></a></li>
        <li>
...
<div class="container">
  <div id="nav_home">
    <ul class="nav_list">
      ...
      <li style="width: 260px;margin-left:-40px;background-color: #e6992e;"><a style="cursor: pointer"><?php echo $text_all_category; ?></a></li>
      <?php } ?>
