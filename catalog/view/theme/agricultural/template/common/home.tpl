...
<div style="width: 100%;background-color: #fcfcfc;">
  <div class="container">
    <div class="row"><?php echo $column_left; ?>
      ...
      <?php $class = 'col-sm-12'; ?>
      <?php } ?>
      <div id="content" class="<?php echo $class; ?>" style="border:0px solid green;">
            ...
            <div class="list-purchased">
              <div class="main-product-list">
                <div class="product-list-h3">
                  <span style="display: inline-block;font-size: 22px;color: #333"><img src="catalog/view/theme/agricultural/image/agricualtual-reclogo.png"> <?php echo $text_recommand; ?></span>
                </div>
              ...
              <div class="main-purchased clearfix" style="display: none">
                <div class="product-list-h3">
                  <span style="display: inline-block;font-size: 22px;color: #333"><img src="catalog/view/theme/agricultural/image/agricualtual-reclogo.png"> <?php echo $text_purchase; ?></span>
                </div>
                ...
                <span><?php echo $text_has_as; ?>
                  <?php } ?>
                    ...
                    <div class="purchased-right-r">
                      ...
                      <div><a   href="<?php echo $purchase['url']; ?>"><?php echo $text_offer_immediately; ?></a></div>
                    </div>
                  </div>
                </div>
                <?php } ?>
              ...
              <div class="list-purchased">
                <div class="list-purchsed-head">
                  <span style="display: inline-block;font-size: 22px;color: #333">
                    <img src="catalog/view/theme/agricultural/image/agricualtual-needlogo.png"> <?php echo $text_purchase; ?></span>
                </div>
                ...
                <div class="household clearfix">
                  ...
                  <?php foreach($purchaseProduct as $purchase){ ?>
                  <div class="house-div">
                    <div class="house-head"><?php echo $purchase['name']; ?></div>
                    <div class="house-mid clearfix">
                      <div class="house-mid-l">
                        <p><?php echo $text_amount_purchased; ?></p>
                        <p><span><?php echo $purchase['total_product']; ?></span></p>
                      </div>
                      <div class="house-mid-m">
                        <p><?php echo $text_release_time; ?><?php echo $purchase['date_added']; ?></p>
                        <p><?php echo $text_days_remaining; ?>
                          <?php if($purchase['date_remaining'] > 0){ ?>
                          <span><?php echo $purchase['date_remaining']; ?></span><?php echo $text_day; ?>
                ...
                <div class="supplier-main">
                  <div class="list-purchsed-head">
                  <span style="display: inline-block;font-size: 22px;color: #333">
                    <img src="catalog/view/theme/agricultural/image/agricualtual-suplogo.png" style="margin-top: -3px">
                    <?php echo $text_supply; ?>
                  </span>
                  </div>
                  <div class="agricultural-sup clearfix">
                    ...
                    <div class="sup-div">
                      <div class="sup-head"><?php echo $category_tree['name']; ?></div>
                      <div class="sup-img-word clearfix">
                        <div class="sup-img">
                          <img src="<?php echo $category_tree['category_image']; ?>"><br/>
                          <img src="catalog/view/theme/agricultural/image/agricultural-sup2.png" style="margin-top: 20px">
                        </div>
                        <div class="sup-word">
                          <p>
