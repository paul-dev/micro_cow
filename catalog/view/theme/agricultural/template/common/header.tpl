...
<link rel="stylesheet" href="catalog/view/theme/agricultural/stylesheet/base.css">
<link href="catalog/view/theme/agricultural/stylesheet/stylesheet.css" rel="stylesheet">

  <!-- load style start -->
  <!--my-main-page -->
  <script src="catalog/view/theme/agricultural/js/index_my.js" type="text/javascript"></script>
  <!--<script src="js/jquery.SuperSlide.2.1.1.js" type="text/javascript"></script>-->
  <link href="catalog/view/theme/agricultural/stylesheet/normalize-3.0.3.css" type="text/css" rel="stylesheet">
  <link href="catalog/view/theme/agricultural/stylesheet/my_main.css" type="text/css" rel="stylesheet">
  <link href="catalog/view/theme/agricultural/stylesheet/agricultural.css" type="text/css" rel="stylesheet">
  <!-- load style end -->

  <!--[if (lt IE 9)]><link href="catalog/view/theme/agricultural/stylesheet/stylesheet-ltie9.css" rel="stylesheet"><![endif]-->
  ...
  <div class="container" style="padding: 0;">
    <div id="top-links" class="nav">
      ...
      <ul class="top-link-right-ul">
        ...
        <li style="margin-right: 8px"><a href=""><img src="catalog/view/theme/agricultural/image/weibo.png" style="margin-top: -2px"></a></li>
        <li style="margin-right: 20px"><a href=""><img src="catalog/view/theme/agricultural/image/weixin.png"></a></li>
        <li>
