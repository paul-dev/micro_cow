<div id="content-<?php echo $product_id; ?>">
  <input type="hidden" name="offer_product[<?php echo $product_id; ?>][product_id]" value="<?php echo $offer_product_id; ?>" />
  <div class="page-header" style="margin-top: 0px;">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" onclick="saveOfferProduct(<?php echo $product_id; ?>)" form="form-product-<?php echo $product_id; ?>" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
        <a href="javascript:void(0);" onclick="$(this).closest('.modal').find('.modal-header button.close').click();" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product-<?php echo $product_id; ?>" class="form-horizontal">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_general; ?></a></li>
            <li><a href="#tab-data-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_data; ?></a></li>
            <li><a href="#tab-links-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_links; ?></a></li>
            <li><a href="#tab-attribute-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            <li><a href="#tab-option-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_option; ?></a></li>
            <!--<li><a href="#tab-recurring-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>-->
            <li><a href="#tab-discount-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
            <li><a href="#tab-special-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_special; ?></a></li>
            <!--<li><a href="#tab-auction-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_auction; ?></a></li>-->
            <li><a href="#tab-image-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_image; ?></a></li>
            <!--<li><a href="#tab-reward-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_reward; ?></a></li>-->
            <!--<li><a href="#tab-design-<?php echo $product_id; ?>" data-toggle="tab"><?php echo $tab_design; ?></a></li>-->
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="dialog-language-<?php echo $product_id; ?>">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#language-<?php echo $product_id; ?>-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="language-<?php echo $product_id; ?>-<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog<?php echo $product_id; ?>-input-description<?php echo $language['language_id']; ?>"><?php echo $entry_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="dialog<?php echo $product_id; ?>-input-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="dialog-input-meta-title<?php echo $language['language_id']; ?>"><?php echo $entry_meta_title; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="dialog-input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
...
<!-- 備註 start -->
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog-input-meta-description<?php echo $language['language_id']; ?>"><?php echo $entry_quotation_note; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_quotation_note" rows="5" placeholder="<?php echo $entry_quotation_note; ?>" id="dialog-input-meta-description<?php echo $language['language_id']; ?>" class="form-control">

                        <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['quotation_note'] : ''; ?>
...
<!-- 備註 end -->
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog-input-meta-description<?php echo $language['language_id']; ?>"><?php echo $entry_meta_description; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="dialog-input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog-input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="dialog-input-tag<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo $entry_tag; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="dialog-input-tag<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-data-<?php echo $product_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-links-<?php echo $product_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-attribute-<?php echo $product_id; ?>">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-attribute-group"><span data-toggle="tooltip" title="">属性组</span></label>
                <div class="col-sm-10">
                  <select name="attribute_group" id="input-attribute-group" class="form-control" style="width: 50%" onchange="addGroupAttribute(this.value);">
                    <option value="">-请选择-</option>
                    <?php foreach ($attribute_groups as $group) { ?>
                    <option value="<?php echo $group['attribute_group_id']; ?>"<?php if (isset($group['selected'])) echo ' selected="selected"'; ?>><?php echo $group['name']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-option-<?php echo $product_id; ?>">
              <div class="row">
                <div class="col-sm-2">
            ...
            <div class="tab-pane" id="tab-recurring-<?php echo $product_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-discount-<?php echo $product_id; ?>">
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-left" width="12%"><?php echo $entry_customer_group; ?></td>
                    <td class="text-right"><?php echo $entry_quantity; ?></td>
            ...
            <div class="tab-pane" id="tab-special-<?php echo $product_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-auction-<?php echo $product_id; ?>">
              <div class="table-responsive">
                <table id="auction" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-left" width="12%"><?php echo $entry_customer_group; ?></td>
                    <td class="text-right"><?php echo $entry_priority; ?></td>
                    <td class="text-right"><?php echo $entry_price; ?></td>
                    <td class="text-right"><?php echo $entry_price_step; ?></td>
                    <td class="text-left"><?php echo $entry_date_start; ?></td>
                    <td class="text-left"><?php echo $entry_date_end; ?></td>
                    <td></td>
                  </tr>
                  ...
                  <input type="hidden" name="product_auction[<?php echo $auction_row; ?>][auction_id]" value="<?php echo isset($product_auction['auction_id']) ? $product_auction['auction_id'] : '0'; ?>" />
                  <tr id="auction-row<?php echo $auction_row; ?>">
                    <td class="text-left" style="width: 15%;"><select name="product_auction[<?php echo $auction_row; ?>][customer_group_id]" class="form-control">
                        <?php foreach ($customer_groups as $customer_group) { ?>
                        <?php if ($customer_group['customer_group_id'] == $product_auction['customer_group_id']) { ?>
                        <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['name']; ?></option>
                        <?php } else { ?>
                        <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['name']; ?></option>
                        <?php } ?>
                    ...
                    <td class="text-right"><input type="text" name="product_auction[<?php echo $auction_row; ?>][priority]" value="<?php echo $product_auction['priority']; ?>" placeholder="<?php echo $entry_quantity; ?>" class="form-control" /></td>
                    <td class="text-right"><input type="text" name="product_auction[<?php echo $auction_row; ?>][base_price]" value="<?php echo $product_auction['base_price']; ?>" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>
                    <td class="text-right"><input type="text" name="product_auction[<?php echo $auction_row; ?>][price]" value="<?php echo $product_auction['price']; ?>" placeholder="<?php echo $entry_price_step; ?>" class="form-control" /></td>
                    <td class="text-left" style="width: 20%;"><div class="input-group datetime">
                        <input type="text" name="product_auction[<?php echo $auction_row; ?>][date_start]" value="<?php echo $product_auction['date_start']; ?>" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD HH:mm" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                    <td class="text-left" style="width: 20%;"><div class="input-group datetime">
                        <input type="text" name="product_auction[<?php echo $auction_row; ?>][date_end]" value="<?php echo $product_auction['date_end']; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD HH:mm" class="form-control" />
                          <span class="input-group-btn">
                          <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                          </span></div></td>
                    <td class="text-left"><button type="button" onclick="$('#auction-row<?php echo $auction_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                  </tr>
                  <?php $auction_row++; ?>
                  <?php } ?>
                  </tbody>
                  ...
                  <tr>
                    <td colspan="6"></td>
                    <td class="text-left"><button type="button" onclick="addAuction();" data-toggle="tooltip" title="<?php echo $button_auction_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                  </tr>
                  </tfoot>
                </table>
              </div>
            ...
            <div class="tab-pane" id="tab-image-<?php echo $product_id; ?>">
              <div class="table-responsive">
            ...
            <div class="tab-pane" id="tab-reward-<?php echo $product_id; ?>">
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-design-<?php echo $product_id; ?>">
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                  <tr>
  ...
  <script type="text/javascript"><!--
    <?php foreach ($languages as $language) { ?>
      $('#dialog<?php echo $product_id; ?>-input-description<?php echo $language['language_id']; ?>').summernote({height: 300});
    <?php } ?>
    //--></script>
  <script type="text/javascript"><!--
    ...
    function validateForm(obj) {
      ...
      $('#'+_form).find('.form-group.required select').each(function(){
        if (!$(this).val()) {
          _pass = false;
  ...
  <script type="text/javascript"><!--
    ...
    <?php foreach ($customer_groups as $customer_group) { ?>
      ...
      $('#tab-recurring-<?php echo $product_id; ?> table tbody').append(html);
    }
    //--></script>
  <script type="text/javascript"><!--
    $('.date').datetimepicker({
    ...
    //--></script>
  <script type="text/javascript"><!--
    $('#dialog-language-<?php echo $product_id; ?> a:first').tab('show');
