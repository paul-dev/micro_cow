<?php
class ControllerSellerFilter extends Controller {
	private $error = array();
	...
	public function edit() {die('access denied!');
		$this->load->language('catalog/filter');
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
            ...
            $json = $this->model_catalog_category->getCategoryFilters($this->request->get['filter_category']);
        }
