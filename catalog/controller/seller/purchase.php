<?php
class ControllerSellerPurchase extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('seller/purchase');

		$this->document->setTitle($this->language->get('heading_title'));

		$this->load->model('seller/purchase');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_seller_purchase->addPurchase($this->request->post);
			...
			$this->response->redirect($this->url->link('seller/purchase', $url, 'SSL'));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$_check = $this->model_seller_purchase->getPurchase($this->request->get['purchase_id']);
            if ($_check) $this->model_seller_purchase->editPurchase($this->request->get['purchase_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_seller_purchase->getProduct($product_id);
                if ($_check) $this->model_seller_purchase->deleteProduct($product_id);
			}
    ...
    public function disable() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_seller_purchase->getProduct($product_id);
                if ($_check) $this->model_seller_purchase->disableProduct($product_id);
            }
	...
	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_seller_purchase->getProduct($product_id);
                if ($_check) $this->model_seller_purchase->copyProduct($product_id);
			}
	...
	protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('seller/purchase', $url, 'SSL')
        );

		$data['add'] = $this->url->link('seller/purchase/add', $url, 'SSL');
		$data['copy'] = $this->url->link('seller/purchase/copy', $url, 'SSL');
        $data['delete'] = $this->url->link('seller/purchase/delete', $url, 'SSL');
        $data['disable'] = $this->url->link('seller/purchase/disable', $url, 'SSL');
		...
		$purchase_total = $this->model_seller_purchase->getTotalPurchases($filter_data);

		$results = $this->model_seller_purchase->getPurchases($filter_data);
		...
		foreach ($results as $result) {
			...
			$data['purchases'][] = array(
				...
				'edit'       => $this->url->link('seller/purchase/edit', 'purchase_id=' . $result['purchase_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('seller/purchase', 'sort=pd.name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('seller/purchase', 'sort=p.status' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('seller/purchase', $url . '&page={page}', 'SSL');
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/seller/purchase_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/seller/purchase_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/seller/purchase_list.tpl', $data));
        }
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['purchase_id'])) {
			$data['action'] = $this->url->link('seller/purchase/add', $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('seller/purchase/edit', 'purchase_id=' . $this->request->get['purchase_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('seller/purchase', $url, 'SSL');

        $data['is_edit'] = false;

		if (isset($this->request->get['purchase_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$purchase_info = $this->model_seller_purchase->getPurchase($this->request->get['purchase_id']);
            $data['is_edit'] = true;
		}
		...
		if (isset($this->request->post['purchase_description'])) {
			...
			$data['purchase_description'] = $this->model_seller_purchase->getPurchaseDescriptions($this->request->get['purchase_id']);
		} else {
		...
		/*if (isset($this->request->post['product_store'])) {
			...
			$data['product_store'] = $this->model_seller_purchase->getProductStores($this->request->get['product_id']);
		} else {
        ...
        if (isset($this->request->post['purchase_category'])) {
            ...
            $categories = $this->model_seller_purchase->getPurchaseCategories($this->request->get['purchase_id']);
        } else {
            $categories = array();
        }
		...
		if (isset($this->request->post['purchase_product'])) {
            ...
            $purchase_product = $this->model_seller_purchase->getPurchaseProducts($this->request->get['purchase_id']);
		} else {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/seller/purchase_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/seller/purchase_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/seller/purchase_form.tpl', $data));
        }
	}

	protected function validateForm() {
		/*if (!$this->user->hasPermission('modify', 'seller/purchase')) {
