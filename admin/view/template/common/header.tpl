...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="/image/catalog/demo/manufacturer/burgerking.png" style="max-height: 25px;" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a>
  <a href="" class="pull-left" style="margin-top: 12px;"><h3>E-Business PMS</h3></a>
  </div>
  <?php if ($logged) { ?>
