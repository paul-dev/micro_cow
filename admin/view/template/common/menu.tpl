<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    ...
    <li id="shop"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_seller; ?></span></a>
        <ul>
            <li><a href="<?php echo $url_seller; ?>"><?php echo $text_shop; ?></a></li>
            <li><a class="parent">用户管理</a>
                <ul>
                    <li><a href="<?php echo $link_platform_user; ?>">用户</a></li>
                    <li><a href="<?php echo $link_platform_user_group; ?>">用户组</a></li>
                </ul>
            </li>
        </ul>
    </li>
