        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-user-group" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-group-store">用户平台</label>
                <div class="col-sm-10">
                    <select name="group_store_id" id="input-group-store" class="form-control">
                        <option value="-1">-请选择-</option>
                        <?php foreach ($user_stores as $user_store) { ?>
                        <?php if ($user_store['store_id'] == $group_store_id) { ?>
