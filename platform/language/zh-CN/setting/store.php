...
// Column
$_['column_name']                      = '平台名称';
$_['column_url']	                   = '平台网址 URL';
$_['column_action']                    = '操作';

// Entry
$_['entry_url']                        = '平台网址 URL';
$_['entry_status']                     = '状态';
$_['entry_key']                        = '站内标识';
$_['entry_ssl']                        = '使用 SSL';
$_['entry_name']                       = '平台名称';
...
$_['entry_image_location']             = '平台图标尺寸';
$_['entry_width']                      = '宽度';
$_['entry_height']                     = '高度';
$_['entry_secure']                     = '使用 SSL';

// Help
$_['help_url']                         = '请输入你平台的完整网址。 注意在最后加上 \'/\' 。 例： http：//www.yourdomain.com/path/<br /><br />请用新的域名或二级域名指定到你的主机。';
$_['help_key']                         = '请输入由a-z组成3-10位长度的唯一标识！';
...
// Error
$_['error_key']                        = '警告:站内标识只能由a-z组成，3-10位长度！';
$_['error_shop_exist']                 = '警告:站内标识已被其它店铺使用！';
$_['error_warning']                    = '警告:请仔细检查相关错误！';
$_['error_permission']                 = '警告: 无权限修改平台设置！';
...
$_['error_image_location']             = '平台图标尺寸必填！';
$_['error_default']                    = '警告: 不能删除默认平台！';
$_['error_store']                      = '警告: 不能删除该平台，该平台已被关联到 %s 个订单！';
