...
class ControllerSettingStore extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			unset($this->request->post['config_url']);
            unset($this->request->post['config_key']);
            unset($this->request->post['config_status']);
            unset($this->request->post['config_ssl']);
            unset($this->request->post['config_secure']);
            ...
            $this->model_setting_store->editStore($this->config->get('config_store_id'), $this->request->post);

			$this->load->model('setting/setting');

			$this->model_setting_setting->editSetting('config', $this->request->post, $this->config->get('config_store_id'));
	...
	public function getForm() {
        ...
        if (isset($this->error['store_margin'])) {
            $data['error_store_margin'] = $this->error['store_margin'];
        } else {
            $data['error_store_margin'] = '';
        }
        ...
        $data['action'] = $this->url->link('setting/store', 'token=' . $this->session->data['token'], 'SSL');
        ...
        } elseif (isset($store_info['config_status'])) {
            $data['config_status'] = $store_info['config_status'];
        } else {
            $data['config_status'] = '';
        }
        ...
        if (isset($this->request->post['config_cert_approve'])) {
            $data['config_cert_approve'] = $this->request->post['config_cert_approve'];
        } elseif (isset($store_info['config_cert_approve'])) {
            $data['config_cert_approve'] = $store_info['config_cert_approve'];
        } else {
            $data['config_cert_approve'] = 3;
        }

        if (isset($this->request->post['config_cert_comment'])) {
            $data['config_cert_comment'] = $this->request->post['config_cert_comment'];
        } elseif (isset($store_info['config_cert_comment'])) {
            $data['config_cert_comment'] = $store_info['config_cert_comment'];
        } else {
            $data['config_cert_comment'] = '';
        }

        if (isset($this->request->post['config_store_margin'])) {
            $data['config_store_margin'] = $this->request->post['config_store_margin'];
        } elseif (isset($store_info['config_store_margin'])) {
            $data['config_store_margin'] = $store_info['config_store_margin'];
        } else {
            $data['config_store_margin'] = '';
        }
	...
	protected function validateForm() {
        ...
        /*if (!preg_match('/^[a-z]{3,10}$/', $this->request->post['config_key'])) {
            ...
            $shop_check = $this->model_setting_store->getStoreByKey($this->request->post['config_key']);
            if ($shop_check['store_id'] && $this->request->get['store_id'] <> $shop_check['store_id']) {
                $this->error['key'] = $this->language->get('error_shop_exist');
            }
        }*/
        ...
        if (isset($this->request->post['config_cert_type']) && $this->request->post['config_cert_type']) {
            if ((utf8_strlen($this->request->post['config_company_name']) < 4) || (utf8_strlen($this->request->post['config_company_name']) > 64)) {
                $this->error['company_name'] = '公司名称应为 4-64 位字符！';
            }
        ...
        /*if (!is_numeric($this->request->post['config_store_margin'])) {
            $this->error['store_margin'] = '保证金金额应为数字!';
        }*/
