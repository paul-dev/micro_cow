...
class ControllerCatalogProduct extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_catalog_product->getProduct($product_id);
                if ($_check) $this->model_catalog_product->deleteProduct($product_id);
			}
    ...
    public function disable() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_catalog_product->getProduct($product_id);
                if ($_check) $this->model_catalog_product->disableProduct($product_id);
            }
	...
	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $product_id) {
                $_check = $this->model_catalog_product->getProduct($product_id);
                if ($_check) $this->model_catalog_product->copyProduct($product_id);
			}
