...
class ControllerCatalogPurchase extends Controller {
	...
	protected function getList() {
		...
		$purchase_total = $this->model_catalog_purchase->getTotalPurchases($filter_data);
		...
		$data['sort_name'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$data['sort_model'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, 'SSL');
		$data['sort_price'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
		$data['sort_quantity'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=p.quantity' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=p.status' . $url, 'SSL');
		$data['sort_order'] = $this->url->link('catalog/purchase', 'token=' . $this->session->data['token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('catalog/purchase_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['purchase_id'])) {
			$data['action'] = $this->url->link('catalog/purchase/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('catalog/purchase/edit', 'token=' . $this->session->data['token'] . '&purchase_id=' . $this->request->get['purchase_id'] . $url, 'SSL');
		}
		...
		if (isset($this->request->post['purchase_description'])) {
			...
			$data['purchase_description'] = $this->model_catalog_purchase->getPurchaseDescriptions($this->request->get['purchase_id']);
		} else {
		...
		/*if (isset($this->request->post['product_store'])) {
			...
			$data['product_store'] = $this->model_catalog_purchase->getProductStores($this->request->get['product_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('catalog/purchase_form.tpl', $data));
	}
