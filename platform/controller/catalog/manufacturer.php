	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $manufacturer_id) {
				$_check = $this->model_catalog_manufacturer->getManufacturerStores($manufacturer_id);
                if ($_check) $this->model_catalog_manufacturer->deleteManufacturer($manufacturer_id);
			}
