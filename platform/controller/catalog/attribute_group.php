	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $attribute_group_id) {
				$_check = $this->model_catalog_attribute_group->getAttributeGroup($attribute_group_id);
                if ($_check) $this->model_catalog_attribute_group->deleteAttributeGroup($attribute_group_id);
			}
