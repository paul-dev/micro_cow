        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a></li>
              <li><a href="#tab-cert" data-toggle="tab">认证</a></li>
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_url" value="<?php echo $config_url; ?>" placeholder="<?php echo $entry_url; ?>" id="input-url" class="form-control" disabled="disabled" />
                  <?php if ($error_url) { ?>
                ...
                <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-key"><span data-toggle="tooltip" data-html="true" title="<?php echo htmlspecialchars($help_key); ?>"><?php echo $entry_key; ?></span></label>
                    <div class="col-sm-10">
                        <input type="text" name="config_key" value="<?php echo $config_key; ?>" placeholder="<?php echo $entry_key; ?>" id="input-key" class="form-control" disabled="disabled" />
                        <?php if ($error_key) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="config_ssl" value="<?php echo $config_ssl; ?>" placeholder="<?php echo $entry_ssl; ?>" id="input-ssl" class="form-control" disabled="disabled" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="tab-pane" id="tab-cert">
                          ...
                          <div class="row">
                              <div class="col-sm-6">
                                  <label class="radio-inline">
                                      ...
                                      <input type="radio" name="config_cert_type" value="1" checked="checked" /> 公司
                                      <?php } else { ?>
                                      <input type="radio" name="config_cert_type" value="1" /> 公司
                                      <?php } ?>
                                  </label>
                                  <label class="radio-inline">
                                      <?php if ($config_cert_type) { ?>
                                      <input type="radio" name="config_cert_type" value="0" /> 个体
                                      <?php } else { ?>
                                      <input type="radio" name="config_cert_type" value="0" checked="checked" /> 个体
                                      <?php } ?>
                                  </label>
                              </div>
                          </div>
                  ...
                  <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                          <div class="row">
                              <div class="col-sm-6">
                                  <input type="text" name="config_legal_name" value="<?php echo $config_legal_name; ?>" placeholder="姓名" id="input-legal-name" class="form-control" />
                              </div>
                          </div>
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label"><strong>法人代表身份证</strong></label>
                  </div>
                  <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                          <div class="row">
                              <div class="col-sm-6">
                                  <input type="text" name="config_legal_id" value="<?php echo $config_legal_id; ?>" placeholder="身份证号码" id="input-legal-id" class="form-control" />
                              </div>
                          </div>
                  ...
                  <div class="form-group required">
                      <label class="col-sm-2 control-label" for="legal-image-front">身份证正面照片</label>
                      <div class="col-sm-10">
                          <div class="row">
                              <div class="col-sm-6">
                                  <a href="javascript:void(0);" id="legal-image-front" data-toggle="image" class="img-thumbnail"><img src="<?php echo $legal_image_front; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  ...
                  <div class="form-group required">
                      <label class="col-sm-2 control-label" for="legal-image-back">身份证背面照片</label>
                      <div class="col-sm-10">
                          <div class="row">
                              <div class="col-sm-6">
                                  <a href="javascript:void(0);" id="legal-image-back" data-toggle="image" class="img-thumbnail"><img src="<?php echo $legal_image_back; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
