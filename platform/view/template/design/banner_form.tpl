            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left" style="width: 35%;"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?>
                  <?php } ?></td>
                <td class="text-left" style="width: 35%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][link]" value="<?php echo $banner_image['link']; ?>" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>
...
function addImage() {
	...
	<?php } ?>
	html += '  </td>';	
	html += '  <td class="text-left" style="width: 35%;"><input type="text" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';
