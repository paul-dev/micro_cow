...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
      <a href="<?php echo $home; ?>" class="navbar-brand" title="<?php echo $store_name; ?>">
          <?php if ($store_logo) { ?>
          <img src="<?php echo $store_logo; ?>" style="max-height: 25px;" alt="<?php echo $store_name; ?>" title="<?php echo $store_name; ?>" />
          <?php } else { ?>
          <?php echo $store_name; ?>
          <?php } ?>
      </a>
