                ...
                <div class="col-sm-10">
                  ...
                  -->
                    <select name="parent_id" id="input-parent" class="form-control">
                        ...
                        <?php
                        $disabled = '';
                        if ($parent['category_id'] == $category_id) $disabled = ' disabled="disabled"';
                        if ($parent['category_id'] == $parent_id) {
                            echo '<option value="'.$parent['category_id'].'" selected="selected"'.$disabled.'>'.$parent['name'].'</option>';
                        } else {
                            echo '<option value="'.$parent['category_id'].'"'.$disabled.'>'.$parent['name'].'</option>';
                        }
                        ?>
                        <?php } ?>
                    </select>
          ...
          $.ajax({
              ...
              success: function(json) {
                  $.map(json, function(item) {
                      $('#category-filter' + item['filter_id']).remove();
