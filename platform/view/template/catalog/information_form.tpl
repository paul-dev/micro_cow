        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-notice"><span data-toggle="tooltip" title="钩选显示于公告">公告</span></label>
                    <div class="col-sm-10">
                        <div class="checkbox">
                            <label>
                                <?php if ($is_notice) { ?>
                                <input type="checkbox" name="is_notice" value="1" checked="checked" id="input-notice" />
                                <?php } else { ?>
                                <input type="checkbox" name="is_notice" value="1" id="input-notice" />
                                <?php } ?>
                                &nbsp; </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-news"><span data-toggle="tooltip" title="钩选显示于资讯">资讯</span></label>
                    <div class="col-sm-10">
                        <div class="checkbox">
                            <label>
                                <?php if ($is_news) { ?>
                                <input type="checkbox" name="is_news" value="1" checked="checked" id="input-news" />
                                <?php } else { ?>
                                <input type="checkbox" name="is_news" value="1" id="input-news" />
                                <?php } ?>
                                &nbsp; </label>
                        </div>
                    </div>
