    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button type="button" onclick="saveOfferProduct(<?php echo $dialog_id; ?>)" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="dialog-language-<?php echo $dialog_id; ?>">
                ...
                <li><a href="#language-<?php echo $dialog_id; ?>-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
            ...
            <div class="tab-pane" id="tab-links-<?php echo $dialog_id; ?>">
                ...
                <div class="col-sm-10">
                  ...
                  -->
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                        ...
                        <div class="checkbox">
                            <label>
                                <?php if (array_key_exists($category['category_id'], $product_categories)) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  -->
                    <select name="filter_group" id="input-filter" class="form-control">
                        <option value="0"><?php echo $text_none; ?></option>
                        <?php foreach ($filter_groups as $group) { ?>
                        <option value="<?php echo $group['filter_group_id']; ?>"><?php echo $group['name']; ?></option>
                        <?php } ?>
                    </select>
...
$('input[name=\'filter\']').autocomplete({
	...
	'select': function(item) {
      ...
      $('select[name=\'filter_group\']').on('change', function(){
          ...
          $.ajax({
              url: 'index.php?route=catalog/filter/getFiltersByGroup&token=<?php echo $token; ?>&group_id=' +  encodeURIComponent(group_id),
              dataType: 'json',
              success: function(json) {
