              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $information['title']; ?></td>
                    <td class="text-right"><?php echo $information['is_notice'] ? '是' : '否'; ?></td>
                    <td class="text-right"><?php echo $information['is_news'] ? '是' : '否'; ?></td>
                    <td class="text-right"><?php echo $information['is_bottom'] ? '是' : '否'; ?></td>
