...
class ModelCatalogAttributeGroup extends Model {
	public function addAttributeGroup($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_group SET attribute_group_store_id = '" . (int)$this->config->get('config_store_id') . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function getAttributeGroup($attribute_group_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "attribute_group WHERE attribute_group_id = '" . (int)$attribute_group_id . "' AND attribute_group_store_id = '" . (int)$this->config->get('config_store_id') . "'");
	...
	public function getTotalAttributeGroups() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "attribute_group WHERE attribute_group_store_id = '" . (int)$this->config->get('config_store_id') . "'");
