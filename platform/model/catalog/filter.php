...
class ModelCatalogFilter extends Model {
	public function addFilter($data) {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "filter_group` SET filter_store_id = '".(int)$this->config->get('config_store_id')."', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function getFilterGroup($filter_group_id) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "filter_group` fg LEFT JOIN " . DB_PREFIX . "filter_group_description fgd ON (fg.filter_group_id = fgd.filter_group_id) WHERE fg.filter_group_id = '" . (int)$filter_group_id . "' AND fgd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND fg.filter_store_id = '".(int)$this->config->get('config_store_id')."'");

		return $query->row;
	}

	public function getFilterGroups($data = array()) {
		$sql = "SELECT * FROM `" . DB_PREFIX . "filter_group` fg LEFT JOIN " . DB_PREFIX . "filter_group_description fgd ON (fg.filter_group_id = fgd.filter_group_id) WHERE fgd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND fg.filter_store_id = '".(int)$this->config->get('config_store_id')."'";
	...
	public function getTotalFilterGroups() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "filter_group` WHERE filter_store_id = '".(int)$this->config->get('config_store_id')."'");
